...
import fakeVideo from "../assets/fake-video.png";
...
const SingleProject = () => {
  ...
  return (
    <article className="bg-indigo-100 xl:grid xl:w-10/12 xl:grid-cols-[auto_1fr] gap-10 xl:gap-6 items-center justify-center  text-gray-700   p-4 shadow-lg">
      <div>
        <img src={fakeVideo} className="h-full object-contain" alt="" />
      </div>
      <div>
